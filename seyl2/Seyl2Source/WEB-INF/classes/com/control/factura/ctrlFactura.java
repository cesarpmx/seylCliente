...
//  AGREGAS ESTA LÍNEA PARA "VER LOTE":
                            record = record + "verLote:\"<u><a href=# onClick=getDetLotes(Ext.getCmp('gridBuscadorExistencias').getSelectionModel().getLastSelected().get('idProducto'),Ext.getCmp('gridBuscadorExistencias').getSelectionModel().getLastSelected().get('clvProducto'),Ext.getCmp('gridBuscadorExistencias').getSelectionModel().getLastSelected().get('existDisponible'),Ext.getCmp('gridBuscadorExistencias').getSelectionModel().getLastSelected().get('decripcion')) style='color:#1CA4D7; cursor:pointer;'>Ver Lotes</a></u> \" ,";
