...
function getModuloFacturas() {
    ...
    function clickBtnBusqEstatus() {
        ...
        if (Ext.getCmp('idCmbPorteo').getRawValue() != '')
            Porteo = Ext.getCmp('idCmbPorteo').getRawValue();
    ...
    Ext.define('ModelExistenciasProd', {
        extend: 'Ext.data.Model',
        fields: ['kardex', 'imagen','verLote', 'idProducto', 'clvProducto', 'decripcion',
    ...
    function BtnBusqExistncs() {
        ...
        if (Ext.getCmp('idCmbFamili').getRawValue() != '')
            Famili = Ext.getCmp('idCmbFamili').getRawValue();
        idFamili = Ext.getCmp('idCmbFamili').getValue();
        if (Ext.getCmp('idCmbLine').getRawValue() != '')
            Line = Ext.getCmp('idCmbLine').getRawValue();
        idLine = Ext.getCmp('idCmbLine').getValue();
        if (Ext.getCmp('sinExist').getValue() != '')
            sinExist = Ext.getCmp('sinExist').getValue();
