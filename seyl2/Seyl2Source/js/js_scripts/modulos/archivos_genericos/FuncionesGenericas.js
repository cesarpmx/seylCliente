...
function createConsulta(id,nom,bnd,qry,clave) {    
    Ext.define('datosConsulta', {
    ...
    return Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: contexto+'/ComboLoader?bnd='+bnd+'&qry='+qry+'&idCampo='+id+'&campo='+nom+'&clave='+clave,
            reader: {
                type: 'json',
...
function createStoreLinea(id,nom,bnd,qry,linea) {    
    Ext.define('datosCombo', {
        extend: 'Ext.data.Model',
        fields: [{
            type: 'string',
    ...
    return Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: contexto+'/ComboLoader?bnd='+bnd+'&qry='+qry+'&idCampo='+id+'&campo='+nom+'&familia='+linea,
            reader: {
                type: 'json',
                successProperty: 'success',
                root: 'records'
